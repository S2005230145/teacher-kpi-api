...
public class BusinessConstant {
    ...
    public static final String OPERATION_LEAVE_WITH = "OPERATION_LEAVE_WITH";
    ...
    public static final String KEY_AUTH_SEC = "X-AUTH-SEC";
    public static final String KEY_AUTH_TOKEN_UID = "X-AUTH-TOKEN-UID";
    public static final String KEY_AUTH_ADMIN_TOKEN = "X-AUTH-ADMIN-TOKEN";
    ...
    public static final String PARAM_KEY_SERVICE_FEE_POINT = "PARAM_KEY_SERVICE_FEE_POINT";
    ...
    public static final String OPERATION_USE_CARD_COUPON = "OPERATION_USE_CARD_COUPON";
    public static final String OPERATION_HANDLE_APPLY_CONFIRM = "OPERATION_HANDLE_APPLY_CONFIRM";
    
    public static final String PARAM_KEY_QIANMING_APP_KEY = "PARAM_KEY_QIANMING_APP_KEY";
    public static final String PARAM_KEY_QIANMING_SECRET = "PARAM_KEY_QIANMING_SECRET";


    public static final String PARAM_KEY_CABINET_APP_ID = "PARAM_KEY_CABINET_APP_ID";
    public static final String PARAM_KEY_CABINET_SECRET_CODE = "PARAM_KEY_CABINET_SECRET_CODE";
    public static final String PARAM_KEY_PLATFORM_FIX_FEE = "PARAM_KEY_PLATFORM_FIX_FEE";

    public static final String PARAM_KEY_SAME_DELIVER_TIME = "PARAM_KEY_SAME_DELIVER_TIME";
    public static final String PARAM_KEY_DIFF_DELIVER_TIME = "PARAM_KEY_DIFF_DELIVER_TIME";



    public static final String PARAM_KEY_MIN_WITHDRAW_AMOUNT = "PARAM_KEY_MIN_WITHDRAW_AMOUNT";
    ...
    public static final String PARAM_KEY_WE_PAY_KEY_SUB_SERIAL_NO = "PARAM_KEY_WE_PAY_KEY_SUB_SERIAL_NO";//序列号
    public static final String PARAM_KEY_WE_PAY_SUB_API_V3_KEY = "PARAM_KEY_WE_PAY_SUB_API_V3_KEY";
    public static final String PARAM_KEY_WE_PAY_SUB_PRIVATE_KEY = "PARAM_KEY_WE_PAY_SUB_PRIVATE_KEY";
}
